    ...
    <div class="relative">
      ...
      >
        <div
          ...
          :key="index"
          class="hover:bg-brand-100 hover:text-brand-500 text-brand-600 cursor-pointer px-4 py-2 select-none"
...
const apiKey = import.meta.env.VITE_GOOGLE_MAPS_API_KEY || "AIzaSyDfrFi_sxwVz2hOci6k7dAorxDtoRLVALI"
