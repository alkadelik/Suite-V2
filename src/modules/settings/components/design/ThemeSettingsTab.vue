<template>
  <section>
    <div
      class="mt-3 flex flex-col justify-between gap-3 border-b border-gray-200 pb-3 md:flex-row md:items-center"
    >
      <SectionHeader
      ...
      <div class="flex items-center gap-2">
        <AppButton icon="clock-rewind" color="alt" />
...
import LogoFaviconSettings from "./theme-settings/LogoFaviconSettings.vue"
import ColorSettings from "./theme-settings/ColorSettings.vue"
import TypographySettings from "./theme-settings/TypographySettings.vue"
import ButtonSettings from "./theme-settings/ButtonSettings.vue"
import FooterSettings from "./theme-settings/FooterSettings.vue"
import LinksSettings from "./theme-settings/LinksSettings.vue"
