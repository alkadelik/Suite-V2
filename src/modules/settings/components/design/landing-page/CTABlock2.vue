...
const props = defineProps<{ ctaBlock2Section?: ThemeSection | null }>()
...
const onSubmit = handleSubmit((values) => {
  if (!props.ctaBlock2Section?.uid) {
    return toast.error("CTA Block 2 section not found. Please refresh the page.")
  }
  ...
  updateSection(
    { id: props.ctaBlock2Section.uid, body: formData },
    {
      onSuccess: () => {
