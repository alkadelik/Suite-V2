<template>
  <div class="space-y-6">
    <div data-validation-target="product_name">
      <TextField
        v-model="productName"
        name="product_name"
        label="Product Name"
    ...
    <div data-validation-target="product_category">
      <SelectField
...
import type { IProductDetailsValidationErrors } from "../../composables/useVariantValidation"
...
interface Props {
  ...
  errors?: IProductDetailsValidationErrors
}
