...
const handleNext = () => {
  ...
  scrollToAndFocusValidationTarget("order-select-product", {
    behavior: "smooth",
    block: "start",
  })
}
...
<template>
  <div>
    ...
    <!-- Products List -->
    <section
      data-validation-target="order-select-product"
      ref="scrollContainer"
    ...
    >
      <ProductSelectionItem
        ...
        :disabled="getAvailableProductQty(prod) === 0"
