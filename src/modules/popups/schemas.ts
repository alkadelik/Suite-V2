...
// Editing allows past start dates (the popup may already be running); the form
// shows a warning instead of a hard error in that case.
export const getValidationSchema = (isEditMode = false) =>
  yup.object({
    name: yup
      .string()
